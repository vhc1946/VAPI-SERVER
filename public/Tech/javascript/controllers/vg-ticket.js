...
var qactions = {
  present:{
    ...
    src:'http://3.135.202.40/repo/assets/icons/document-signed.png',
    title:'Presentation',
...
var mactions = {
  save:{
    id:'wo-save-button',
    src:'http://3.135.202.40/repo/assets/icons/disk.png',
    title:'Save WO',
    ondblclick:(ele)=>{
      window.SAVEticket();
    }
  ...
  refresh:{
    ...
    src:'http://3.135.202.40/repo/assets/icons/refresh.png',
    title:'Refresh WO',
