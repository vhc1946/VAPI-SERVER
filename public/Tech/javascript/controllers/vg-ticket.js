...
var qactions = {
  present:{
    ...
    src:'https://vogel.vhpportal.com/repo/assets/icons/document-signed.png',
    title:'Presentation',
...
var mactions = {
  save:{
    id:'wo-save-button',
    src:'https://vogel.vhpportal.com/repo/assets/icons/disk.png',
    title:'Save WO',
    ondblclick:(ele)=>{
      window.SAVEticket();
    }
  ...
  refresh:{
    ...
    src:'https://vogel.vhpportal.com/repo/assets/icons/refresh.png',
    title:'Refresh WO',
