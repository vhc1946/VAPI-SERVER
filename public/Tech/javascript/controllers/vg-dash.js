...
import * as titlebar from 'http://3.135.202.40/repo/modules/vg-titlebar.js';
import { SELECTview } from 'http://3.135.202.40/repo/modules/vg-floatviews.js';
import { AppDock } from 'http://3.135.202.40/repo/modules/appdock.js';
import {STARTloadscreen} from 'http://3.135.202.40/repo/tools/vhc-loadscreen.js';
...
var qactions = {
  new:{
    id:'search-wo',
    src:'http://3.135.202.40/repo/assets/icons/search.png',
    alt:'SEARCH',
    title:'Search WO',
...
var mactions = {
  datalist:{
    id:'refresh-datalist',
    src:'http://3.135.202.40/repo/assets/icons/datastores.png',
    ondblclick:(ele)=>{
