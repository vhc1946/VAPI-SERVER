...
<table cellpadding="0" cellspacing="0">
  <tr><td><h3>Dear <span id="client-name">Client</span>,</h3>
  </td></tr>
  ...
  <td>
    <img src="cid:installvehicle@vogelheating.com" style="width:250px;border:2px solid black;padding:3px;" border="2" width="250" padding="3">
  </td></tr>
  </table></td></tr>
  <tr><td style="border-left:2px solid blue;background-color:blue;color:white;font-weight:bold;padding:5px;width:100%;">HAVE ANY QUESTIONS?  -  NEED TO ADJUST YOUR APPOINTMENT?</td></tr>
  ...
  <tr><td style="padding-top:10px;">
    ...
    <img src="cid:vogellogo@vogelheating.com" alt="VOGEL H&C">
  </td></tr>
</table>
</body>`