...
import {FINDparentele} from 'http://3.145.12.72//repo/tools/vg-displaytools.js';
...
const wotablerow=`
  <div class="${wrdom.values.dateschedule}"></div>
    ...
    <div class="techwo-row-actions">
      <div class = "action-button" id = "button-delete" ><img class="${wrdom.actions.delete}" src="http://3.145.12.72//repo/assets/icons/cross.png"/></div>
      <div class = "action-button" id = "button-open" ><img class="${wrdom.actions.open}" src="http://3.145.12.72//repo/assets/icons/edit.png"/></div>
    </div>
`
// DATA //
