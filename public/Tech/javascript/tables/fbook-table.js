...
import * as gendis from '/repo/js/modules/vg-tables.js';
import {FINDparentele} from '/repo/js/tools/vg-displaytools.js';
import {ObjList} from '/rep/js/tools/vg-lists.js';
