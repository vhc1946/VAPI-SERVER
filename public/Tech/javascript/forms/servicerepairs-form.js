import {FormList} from 'http://3.145.12.72//repo/tools/vhc-formlist.js';
import * as ttools from 'http://3.145.12.72//repo/modules/vg-tables.js';
import { DropNote } from 'http://3.145.12.72//repo/modules/vg-dropnote.js';
import {aflatrepair} from 'http://3.145.12.72//repo/ds/jonas/flatratebook.js';
...
export class SIrepairform extends FormList{
  ...
  <div class="${this.dom.cont}">
    <div class="${this.dom.table.actions}">
      ...
      <div class="icon-action-button ${this.dom.actions.add} "><img src="http://3.145.12.72//repo/assets/icons/add.png"/></div></div>
  ...
  row=`
    ...
    <img class="delete-repair-item" src="http://3.145.12.72//repo/assets/icons/trash.png">
  `
  get addform(){
    let form={};
